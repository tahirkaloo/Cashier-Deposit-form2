...
<div class="container">
    <!-- Feautres here are still under development!!! -->
    <h2 style="text-align: center; color: #ff0000;">Feautres here are still under development!!!</h2>
    ...
    <?php else: ?>
        ...
        <form method="post" action="">
            ...
            <?php else: ?>
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" required disabled> <!-- Disable the input field-->
                </div>
                <div class="form-group">
                    <button type="submit" class="button" disabled>Send Reset Link</button> <!-- Disable the button -->
                </div>
            <?php endif; ?>
        </form>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" placeholder="Enter your email" required disabled> <!-- Disable the input field -->
            </div>
            <div class="form-group">
                <input type="submit" name="resend" value="Resend Verification Email" class="resend-button" disabled> <!-- Disable the button -->
            </div>
        </form>
    <?php endif; ?>
</div>
