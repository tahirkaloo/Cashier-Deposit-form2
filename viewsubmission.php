...
<div class="container">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td>Deposit type</td>
                <td><?php echo isset($row['deposit_type']) ? htmlspecialchars($row['deposit_type']) : ''; ?></td>
                <td></td> 
            </tr>
            <tr>
                <td>Drawer Number</td>
                <td><?php echo isset($row['drawer_number']) ? htmlspecialchars($row['drawer_number']) : ''; ?></td>
                <td></td> 
            </tr>
            <tr>
                <td>Cash</td>
                <td></td> 
                <td><?php echo isset($row['cash_amount']) ? htmlspecialchars($row['cash_amount']) : ''; ?></td>
            </tr>
            <tr>
                <td>Check 21 - Deposit</td>
                <td><?php echo isset($row['check21_deposit_count']) ? htmlspecialchars($row['check21_deposit_count']) : ''; ?></td> 
                <td><?php echo isset($row['check21_deposit_amount']) ? htmlspecialchars($row['check21_deposit_amount']) : ''; ?></td> 
            </tr>
            <tr>
                <td>CEO Check Deposit</td>
                <td><?php echo isset($row['ceo_check_deposit_count']) ? htmlspecialchars($row['ceo_check_deposit_count']) : ''; ?></td> 
                <td><?php echo isset($row['ceo_check_deposit_amount']) ? htmlspecialchars($row['ceo_check_deposit_amount']) : ''; ?></td> 
            </tr>
            <tr>
                <td>Manual Check Deposit</td>
                <td><?php echo isset($row['manual_check_deposit_count']) ? htmlspecialchars($row['manual_check_deposit_count']) : ''; ?></td> 
                <td><?php echo isset($row['manual_check_deposit_amount']) ? htmlspecialchars($row['manual_check_deposit_amount']) : ''; ?></td> 
            </tr>
            <tr>
                <td>Money Order</td>
                <td><?php echo isset($row['money_order_deposit_count']) ? htmlspecialchars($row['money_order_deposit_count']) : ''; ?></td> 
                <td><?php echo isset($row['money_order_deposit_amount']) ? htmlspecialchars($row['money_order_deposit_amount']) : ''; ?></td> 
            </tr>
            <tr>
                <td>Credit and Debit Cards</td>
                <td><?php echo isset($row['credit_debit_cards_count']) ? htmlspecialchars($row['credit_debit_cards_count']) : ''; ?></td> 
                <td><?php echo isset($row['credit_debit_cards_amount']) ? htmlspecialchars($row['credit_debit_cards_amount']) : ''; ?></td> 
            </tr>
            <tr>
                <td>Pre-Deposits</td>
                <td><?php echo isset($row['pre_deposit_count']) ? htmlspecialchars($row['pre_deposit_count']) : ''; ?></td> 
                <td><?php echo isset($row['pre_deposit_amount']) ? htmlspecialchars($row['pre_deposit_amount']) : ''; ?></td> 
            </tr>
            <tr>
                <td><strong>Total</strong></td>
                <td><strong><?php echo isset($row['total_count']) ? htmlspecialchars($row['total_count']) : ''; ?></strong></td> 
                <td><strong>$<?php echo isset($row['total_amount']) ? htmlspecialchars($row['total_amount']) : ''; ?></strong></td> 
            </tr>
        </tbody>
    </table>
